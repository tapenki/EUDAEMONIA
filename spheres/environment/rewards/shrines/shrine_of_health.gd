...
func activate():
	...
	active = true
	self.texture_normal = preload("res://spheres/environment/rewards/red_reward.png")
	get_node("Symbol").text = "He"
...
func _on_pressed() -> void:
	...
	get_node("/root/Main/PlayerAbilityHandler").learn("health_boost", 40)
