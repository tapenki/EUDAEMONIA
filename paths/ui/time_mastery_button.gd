...
@onready var day_counter = get_node("/root/Main/UI/HUD/FloorNumber")

@onready var texture_rect1: = $"TextureRect1"
@onready var texture_rect2: = $"TextureRect2"
@onready var symbol_label: = $"Symbol"

@export var accessible_texture_1: Texture2D
@export var accessible_texture_2: Texture2D
...
func update():
	...
	if passed:
		texture_rect1.texture = accessible_texture_1
		texture_rect2.texture = accessible_texture_2
