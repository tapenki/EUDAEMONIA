...
func day_start(_day: int) -> void:
	if osteophalanx:
		...
		summon_instance1.ability_relay.inherited_damage["multiplier"] *= level
		...
		summon_instance2.ability_relay.inherited_damage["multiplier"] *= level
		...
		summon_instance3.ability_relay.inherited_damage["multiplier"] *= level
		...
		summon_instance4.ability_relay.inherited_damage["multiplier"] *= level
		...
		summon_instance.ability_relay.inherited_damage["multiplier"] *= level
